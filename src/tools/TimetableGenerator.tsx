  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-black text-slate-900 mb-4">Study Time Table Generator</h1>
        <p className="text-slate-600">Create and export your daily study schedule to stay organized.</p>
      </div>
